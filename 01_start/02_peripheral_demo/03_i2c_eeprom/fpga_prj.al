...
<Project Version="3" Minor="2" Path="F:/al_data/F01_EG4D20/Fmin01/01_start/02_peripheral_demo/03_i2c_eeprom">
    ...
    <Source_Files>
        <Verilog>
            ...
            <File Path="uisrc/01_rtl/eeprom_test.v">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="design_1"/>
    ...
    <TOP_MODULE>
        <LABEL>sim_top_tb/eeprom_test_inst</LABEL>
        <MODULE>eeprom_test</MODULE>
