...
module fifo_generator_0  // fifo_generator_0.v(14)
  ...
  output [7:0] do;  // fifo_generator_0.v(27)
  output empty_flag;  // fifo_generator_0.v(28)
  output full_flag;  // fifo_generator_0.v(29)
  output [10:0] rdusedw;  // fifo_generator_0.v(30)
  output [10:0] wrusedw;  // fifo_generator_0.v(31)
  ...
  AL_DFF_X gray_counter_reg_al_u29_b9 (
    ...
    .ss(1'b0),
    .q(q9_al_n28));
  AL_DFF_X gray_counter_reg_al_u42_b0 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q0_al_n63));
  AL_DFF_X gray_counter_reg_al_u42_b1 (
    .ar(1'b0),
    .as(rst),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q1_al_n64));
  AL_DFF_X gray_counter_reg_al_u42_b10 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q10_al_n73));
  AL_DFF_X gray_counter_reg_al_u42_b11 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q11_al_n74));
  AL_DFF_X gray_counter_reg_al_u42_b2 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q2_al_n65));
  AL_DFF_X gray_counter_reg_al_u42_b3 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q3_al_n66));
  AL_DFF_X gray_counter_reg_al_u42_b4 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q4_al_n67));
  AL_DFF_X gray_counter_reg_al_u42_b5 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q5_al_n68));
  AL_DFF_X gray_counter_reg_al_u42_b6 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q6_al_n69));
  AL_DFF_X gray_counter_reg_al_u42_b7 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q7_al_n70));
  AL_DFF_X gray_counter_reg_al_u42_b8 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
    ...
    .ss(1'b0),
    .q(q8_al_n71));
  AL_DFF_X gray_counter_reg_al_u42_b9 (
    .ar(rst),
    .as(1'b0),
    .clk(clk),
  ...
  AL_MAP_LUT3 #(
    ...
    .c(curr_state2),
    .o(s_state_mux_o0));
  AL_DFF_X show_ahead_buffer_dff (
    .ar(1'b0),
    .as(rst_neg_neg),
    .clk(clk),
    .d(empty_r_mux_o0),
