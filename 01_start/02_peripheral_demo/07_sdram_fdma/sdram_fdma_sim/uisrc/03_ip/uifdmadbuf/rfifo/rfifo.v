 ...
 ** File	:	F:/al_data/F01_EG4D20/01_start/Fmin01/sdram_tpg/sim_fifo/uisrc/03_ip/uifdmadbuf/rfifo/rfifo.v
 ** Date	:	2025 08 13
 ** TD version	:	5.6.97693
\************************************************************/
module rfifo #(parameter DATA_WIDTH_W = 32, 
        parameter DATA_WIDTH_R = 16, 
        parameter ADDR_WIDTH_W = 10, 
        parameter ADDR_WIDTH_R = 11, 
        parameter AL_FULL_NUM = 1021, 
        parameter AL_EMPTY_NUM = 4, 
